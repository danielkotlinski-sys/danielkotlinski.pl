    ...
    <div className="border border-gray-200 rounded-xl p-6 mb-4">
      ...
      <div className="mb-5">
        ...
        <p className="text-gray-700 leading-relaxed">
          {profile.logikaSprzdazy.tresc}
        </p>
        <div className="flex flex-wrap gap-2 mt-3">
          {profile.logikaSprzdazy.kluczoweMechanizmy.map((m, i) => (
            <span
              key={i}
      ...
      <div className="mb-5">
        ...
        <p className="text-gray-700 leading-relaxed mb-2">
          {profile.implikowanyKlient.tosazmosc}
        </p>
        <p className="text-gray-600 text-sm">
          <span className="font-medium">Co ważne:</span>{' '}
          {profile.implikowanyKlient.coWazne}
        </p>
      </div>
      ...
      <div className="mb-5">
        ...
        <p className="text-gray-600 text-sm">
          {profile.implikowanyKlient.ktoWykluczony}
        </p>
      </div>
      ...
      <div className="mb-5">
        ...
        <div className="space-y-3">
          {profile.kluczoweDowody.map((dowod, i) => (
